    ...
    <div className="illustration">
      ...
      >
        ...
        >
          ...
          <path d="M126 288 L137 340 L148 288" fill="#ffffff" />
          {/* Tie */}
          <path d="M136 295 L138 295 L141 370 L137 378 L133 370 Z" fill="#b91c1c" />
          {/* Lapels */}
          <path d="M116 288 L137 340 L130 345 Z" fill="#1e293b" />
          <path d="M158 288 L137 340 L144 345 Z" fill="#1e293b" />
          {/* Pocket Square */}
          <rect x="116" y="315" width="14" height="4" fill="#ffffff" />

          {/* Left sleeve & arm (resting) */}
          <path d="M118 290 L104 292 L94 330 L106 334 Z" fill="#0f172a" />
          ...
          <g className="recruiter-arm">
            <path d="M156 290 L170 286 L188 322 L172 326 Z" fill="#0f172a" />
            {/* White cuff */}
        ...
        >
          ...
          <path d="M446 290 L456 340 L466 290 Z" fill="#ffffff" />
          <path d="M436 290 L456 340 L450 345 Z" fill="#475569" />
          <path d="M476 290 L456 340 L462 345 Z" fill="#475569" />

          {/* Right arm & sleeve (casual gesture) */}
          <g className="candidate-arm">
            <path d="M438 290 L426 292 L412 320 L422 324 Z" fill="#334155" />
